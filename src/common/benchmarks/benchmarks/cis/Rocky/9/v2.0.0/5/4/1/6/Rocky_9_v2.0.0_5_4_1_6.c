#include "Rocky_9_v2.0.0_5_4_1_6.h"
...
static benchmark_result_t audit(void* log)
{
    ...
    OsConfigLogInfo(log, "[CIS] Audit for benchmarks_cis_Rocky_9_v2_0_0_5_4_1_6");
...
static benchmark_result_t remediate(void *log)
{
    ...
    OsConfigLogInfo(log, "[CIS] Remediation for benchmarks_cis_Rocky_9_v2_0_0_5_4_1_6");
    return BENCHMARK_FAILED;
}

struct benchmarks_cis_Rocky_9_v2_0_0_5_4_1_6 benchmarks_cis_Rocky_9_v2_0_0_5_4_1_6_init()
{
    struct benchmarks_cis_Rocky_9_v2_0_0_5_4_1_6 interface;
...
benchmark_result_t benchmarks_cis_Rocky_9_v2_0_0_5_4_1_6_audit(const struct benchmarks_cis_Rocky_9_v2_0_0_5_4_1_6* interface, const char* path, void* log)
{
    ...
    {
        OsConfigLogError(log, "benchmarks_cis_Rocky_9_v2_0_0_5_4_1_6_audit: NULL argument");
        return BENCHMARK_FAILED;
    }

    if (0 != strcmp(path, "/audit"))
    {
        OsConfigLogError(log, "benchmarks_cis_Rocky_9_v2_0_0_5_4_1_6_audit: Invalid path");
        return BENCHMARK_FAILED;
    }
...
benchmark_result_t benchmarks_cis_Rocky_9_v2_0_0_5_4_1_6_remediate(const struct benchmarks_cis_Rocky_9_v2_0_0_5_4_1_6* interface, const char* path, void* log)
{
    if (NULL == interface || NULL == path)
    {
        OsConfigLogError(log, "benchmarks_cis_Rocky_9_v2_0_0_5_4_1_6_remediate: NULL argument");
        return BENCHMARK_FAILED;
    }

    if (0 != strcmp(path, "/remediate"))
    {
        OsConfigLogError(log, "benchmarks_cis_Rocky_9_v2_0_0_5_4_1_6_remediate: Invalid path");
        return BENCHMARK_FAILED;
    }
