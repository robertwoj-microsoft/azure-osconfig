#include "Oracle_7_v4.0.0_5_1_1_4.h"
...
static benchmark_result_t audit(void* log)
{
    ...
    OsConfigLogInfo(log, "[CIS] Audit for benchmarks_cis_Oracle_7_v4_0_0_5_1_1_4");
...
static benchmark_result_t remediate(void *log)
{
    ...
    OsConfigLogInfo(log, "[CIS] Remediation for benchmarks_cis_Oracle_7_v4_0_0_5_1_1_4");
    return BENCHMARK_FAILED;
}

struct benchmarks_cis_Oracle_7_v4_0_0_5_1_1_4 benchmarks_cis_Oracle_7_v4_0_0_5_1_1_4_init()
{
    struct benchmarks_cis_Oracle_7_v4_0_0_5_1_1_4 interface;
...
benchmark_result_t benchmarks_cis_Oracle_7_v4_0_0_5_1_1_4_audit(const struct benchmarks_cis_Oracle_7_v4_0_0_5_1_1_4* interface, const char* path, void* log)
{
    ...
    {
        OsConfigLogError(log, "benchmarks_cis_Oracle_7_v4_0_0_5_1_1_4_audit: NULL argument");
        return BENCHMARK_FAILED;
    }

    if (0 != strcmp(path, "/audit"))
    {
        OsConfigLogError(log, "benchmarks_cis_Oracle_7_v4_0_0_5_1_1_4_audit: Invalid path");
        return BENCHMARK_FAILED;
    }
...
benchmark_result_t benchmarks_cis_Oracle_7_v4_0_0_5_1_1_4_remediate(const struct benchmarks_cis_Oracle_7_v4_0_0_5_1_1_4* interface, const char* path, void* log)
{
    if (NULL == interface || NULL == path)
    {
        OsConfigLogError(log, "benchmarks_cis_Oracle_7_v4_0_0_5_1_1_4_remediate: NULL argument");
        return BENCHMARK_FAILED;
    }

    if (0 != strcmp(path, "/remediate"))
    {
        OsConfigLogError(log, "benchmarks_cis_Oracle_7_v4_0_0_5_1_1_4_remediate: Invalid path");
        return BENCHMARK_FAILED;
    }
