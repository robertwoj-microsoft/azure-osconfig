#ifndef BENCHMARKS_CIS_DEBIAN_10_H
#define BENCHMARKS_CIS_DEBIAN_10_H
...
#include "v2.0.0/Debian_10_v2.0.0.h"

struct benchmarks_cis_Debian_10
{
    struct benchmarks_cis_Debian_10_v2_0_0 rule_v2_0_0;
};
...
#endif // BENCHMARKS_CIS_DEBIAN_10_H
