#include "Debian_12_v1.1.0_5_1_14.h"
...
static benchmark_result_t audit(void* log)
{
    ...
    OsConfigLogInfo(log, "[CIS] Audit for benchmarks_cis_Debian_12_v1_1_0_5_1_14");
...
static benchmark_result_t remediate(void *log)
{
    ...
    OsConfigLogInfo(log, "[CIS] Remediation for benchmarks_cis_Debian_12_v1_1_0_5_1_14");
    return BENCHMARK_FAILED;
}

struct benchmarks_cis_Debian_12_v1_1_0_5_1_14 benchmarks_cis_Debian_12_v1_1_0_5_1_14_init()
{
    struct benchmarks_cis_Debian_12_v1_1_0_5_1_14 interface;
...
benchmark_result_t benchmarks_cis_Debian_12_v1_1_0_5_1_14_audit(const struct benchmarks_cis_Debian_12_v1_1_0_5_1_14* interface, const char* path, void* log)
{
    ...
    {
        OsConfigLogError(log, "benchmarks_cis_Debian_12_v1_1_0_5_1_14_audit: NULL argument");
        return BENCHMARK_FAILED;
    }

    if (0 != strcmp(path, "/audit"))
    {
        OsConfigLogError(log, "benchmarks_cis_Debian_12_v1_1_0_5_1_14_audit: Invalid path");
        return BENCHMARK_FAILED;
    }
...
benchmark_result_t benchmarks_cis_Debian_12_v1_1_0_5_1_14_remediate(const struct benchmarks_cis_Debian_12_v1_1_0_5_1_14* interface, const char* path, void* log)
{
    if (NULL == interface || NULL == path)
    {
        OsConfigLogError(log, "benchmarks_cis_Debian_12_v1_1_0_5_1_14_remediate: NULL argument");
        return BENCHMARK_FAILED;
    }

    if (0 != strcmp(path, "/remediate"))
    {
        OsConfigLogError(log, "benchmarks_cis_Debian_12_v1_1_0_5_1_14_remediate: Invalid path");
        return BENCHMARK_FAILED;
    }
