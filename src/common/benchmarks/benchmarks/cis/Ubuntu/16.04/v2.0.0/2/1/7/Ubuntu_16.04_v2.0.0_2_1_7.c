#include "Ubuntu_16.04_v2.0.0_2_1_7.h"
...
static benchmark_result_t audit(void* log)
{
    ...
    OsConfigLogInfo(log, "[CIS] Audit for benchmarks_cis_Ubuntu_16_04_v2_0_0_2_1_7");
...
static benchmark_result_t remediate(void *log)
{
    ...
    OsConfigLogInfo(log, "[CIS] Remediation for benchmarks_cis_Ubuntu_16_04_v2_0_0_2_1_7");
    return BENCHMARK_FAILED;
}

struct benchmarks_cis_Ubuntu_16_04_v2_0_0_2_1_7 benchmarks_cis_Ubuntu_16_04_v2_0_0_2_1_7_init()
{
    struct benchmarks_cis_Ubuntu_16_04_v2_0_0_2_1_7 interface;
...
benchmark_result_t benchmarks_cis_Ubuntu_16_04_v2_0_0_2_1_7_audit(const struct benchmarks_cis_Ubuntu_16_04_v2_0_0_2_1_7* interface, const char* path, void* log)
{
    ...
    {
        OsConfigLogError(log, "benchmarks_cis_Ubuntu_16_04_v2_0_0_2_1_7_audit: NULL argument");
        return BENCHMARK_FAILED;
    }

    if (0 != strcmp(path, "/audit"))
    {
        OsConfigLogError(log, "benchmarks_cis_Ubuntu_16_04_v2_0_0_2_1_7_audit: Invalid path");
        return BENCHMARK_FAILED;
    }
...
benchmark_result_t benchmarks_cis_Ubuntu_16_04_v2_0_0_2_1_7_remediate(const struct benchmarks_cis_Ubuntu_16_04_v2_0_0_2_1_7* interface, const char* path, void* log)
{
    if (NULL == interface || NULL == path)
    {
        OsConfigLogError(log, "benchmarks_cis_Ubuntu_16_04_v2_0_0_2_1_7_remediate: NULL argument");
        return BENCHMARK_FAILED;
    }

    if (0 != strcmp(path, "/remediate"))
    {
        OsConfigLogError(log, "benchmarks_cis_Ubuntu_16_04_v2_0_0_2_1_7_remediate: Invalid path");
        return BENCHMARK_FAILED;
    }
