#include "Ubuntu_18.04_v2.2.0_4_4_1.h"
...
static benchmark_result_t audit(void* log)
{
    ...
    OsConfigLogInfo(log, "[CIS] Audit for benchmarks_cis_Ubuntu_18_04_v2_2_0_4_4_1");
...
static benchmark_result_t remediate(void *log)
{
    ...
    OsConfigLogInfo(log, "[CIS] Remediation for benchmarks_cis_Ubuntu_18_04_v2_2_0_4_4_1");
    return BENCHMARK_FAILED;
}

struct benchmarks_cis_Ubuntu_18_04_v2_2_0_4_4_1 benchmarks_cis_Ubuntu_18_04_v2_2_0_4_4_1_init()
{
    struct benchmarks_cis_Ubuntu_18_04_v2_2_0_4_4_1 interface;
...
benchmark_result_t benchmarks_cis_Ubuntu_18_04_v2_2_0_4_4_1_audit(const struct benchmarks_cis_Ubuntu_18_04_v2_2_0_4_4_1* interface, const char* path, void* log)
{
    ...
    {
        OsConfigLogError(log, "benchmarks_cis_Ubuntu_18_04_v2_2_0_4_4_1_audit: NULL argument");
        return BENCHMARK_FAILED;
    }

    if (0 != strcmp(path, "/audit"))
    {
        OsConfigLogError(log, "benchmarks_cis_Ubuntu_18_04_v2_2_0_4_4_1_audit: Invalid path");
        return BENCHMARK_FAILED;
    }
...
benchmark_result_t benchmarks_cis_Ubuntu_18_04_v2_2_0_4_4_1_remediate(const struct benchmarks_cis_Ubuntu_18_04_v2_2_0_4_4_1* interface, const char* path, void* log)
{
    if (NULL == interface || NULL == path)
    {
        OsConfigLogError(log, "benchmarks_cis_Ubuntu_18_04_v2_2_0_4_4_1_remediate: NULL argument");
        return BENCHMARK_FAILED;
    }

    if (0 != strcmp(path, "/remediate"))
    {
        OsConfigLogError(log, "benchmarks_cis_Ubuntu_18_04_v2_2_0_4_4_1_remediate: Invalid path");
        return BENCHMARK_FAILED;
    }
