#include "Ubuntu_24.04_v1.0.0_2_1_16.h"
...
static benchmark_result_t audit(void* log)
{
    ...
    OsConfigLogInfo(log, "[CIS] Audit for benchmarks_cis_Ubuntu_24_04_v1_0_0_2_1_16");
...
static benchmark_result_t remediate(void *log)
{
    ...
    OsConfigLogInfo(log, "[CIS] Remediation for benchmarks_cis_Ubuntu_24_04_v1_0_0_2_1_16");
    return BENCHMARK_FAILED;
}

struct benchmarks_cis_Ubuntu_24_04_v1_0_0_2_1_16 benchmarks_cis_Ubuntu_24_04_v1_0_0_2_1_16_init()
{
    struct benchmarks_cis_Ubuntu_24_04_v1_0_0_2_1_16 interface;
...
benchmark_result_t benchmarks_cis_Ubuntu_24_04_v1_0_0_2_1_16_audit(const struct benchmarks_cis_Ubuntu_24_04_v1_0_0_2_1_16* interface, const char* path, void* log)
{
    ...
    {
        OsConfigLogError(log, "benchmarks_cis_Ubuntu_24_04_v1_0_0_2_1_16_audit: NULL argument");
        return BENCHMARK_FAILED;
    }

    if (0 != strcmp(path, "/audit"))
    {
        OsConfigLogError(log, "benchmarks_cis_Ubuntu_24_04_v1_0_0_2_1_16_audit: Invalid path");
        return BENCHMARK_FAILED;
    }
...
benchmark_result_t benchmarks_cis_Ubuntu_24_04_v1_0_0_2_1_16_remediate(const struct benchmarks_cis_Ubuntu_24_04_v1_0_0_2_1_16* interface, const char* path, void* log)
{
    if (NULL == interface || NULL == path)
    {
        OsConfigLogError(log, "benchmarks_cis_Ubuntu_24_04_v1_0_0_2_1_16_remediate: NULL argument");
        return BENCHMARK_FAILED;
    }

    if (0 != strcmp(path, "/remediate"))
    {
        OsConfigLogError(log, "benchmarks_cis_Ubuntu_24_04_v1_0_0_2_1_16_remediate: Invalid path");
        return BENCHMARK_FAILED;
    }
