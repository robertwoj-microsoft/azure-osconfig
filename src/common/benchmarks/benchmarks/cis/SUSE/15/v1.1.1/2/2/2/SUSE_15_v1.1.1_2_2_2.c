#include "SUSE_15_v1.1.1_2_2_2.h"
...
static benchmark_result_t audit(void* log)
{
    ...
    OsConfigLogInfo(log, "[CIS] Audit for benchmarks_cis_SUSE_15_v1_1_1_2_2_2");
...
static benchmark_result_t remediate(void *log)
{
    ...
    OsConfigLogInfo(log, "[CIS] Remediation for benchmarks_cis_SUSE_15_v1_1_1_2_2_2");
    return BENCHMARK_FAILED;
}

struct benchmarks_cis_SUSE_15_v1_1_1_2_2_2 benchmarks_cis_SUSE_15_v1_1_1_2_2_2_init()
{
    struct benchmarks_cis_SUSE_15_v1_1_1_2_2_2 interface;
...
benchmark_result_t benchmarks_cis_SUSE_15_v1_1_1_2_2_2_audit(const struct benchmarks_cis_SUSE_15_v1_1_1_2_2_2* interface, const char* path, void* log)
{
    ...
    {
        OsConfigLogError(log, "benchmarks_cis_SUSE_15_v1_1_1_2_2_2_audit: NULL argument");
        return BENCHMARK_FAILED;
    }

    if (0 != strcmp(path, "/audit"))
    {
        OsConfigLogError(log, "benchmarks_cis_SUSE_15_v1_1_1_2_2_2_audit: Invalid path");
        return BENCHMARK_FAILED;
    }
...
benchmark_result_t benchmarks_cis_SUSE_15_v1_1_1_2_2_2_remediate(const struct benchmarks_cis_SUSE_15_v1_1_1_2_2_2* interface, const char* path, void* log)
{
    if (NULL == interface || NULL == path)
    {
        OsConfigLogError(log, "benchmarks_cis_SUSE_15_v1_1_1_2_2_2_remediate: NULL argument");
        return BENCHMARK_FAILED;
    }

    if (0 != strcmp(path, "/remediate"))
    {
        OsConfigLogError(log, "benchmarks_cis_SUSE_15_v1_1_1_2_2_2_remediate: Invalid path");
        return BENCHMARK_FAILED;
    }
