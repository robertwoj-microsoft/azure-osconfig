#include "Alma_9_v3.0.0_7_1_13.h"
...
static benchmark_result_t audit(void* log)
{
    ...
    OsConfigLogInfo(log, "[CIS] Audit for benchmarks_cis_Alma_9_v3_0_0_7_1_13");
...
static benchmark_result_t remediate(void *log)
{
    ...
    OsConfigLogInfo(log, "[CIS] Remediation for benchmarks_cis_Alma_9_v3_0_0_7_1_13");
    return BENCHMARK_FAILED;
}

struct benchmarks_cis_Alma_9_v3_0_0_7_1_13 benchmarks_cis_Alma_9_v3_0_0_7_1_13_init()
{
    struct benchmarks_cis_Alma_9_v3_0_0_7_1_13 interface;
...
benchmark_result_t benchmarks_cis_Alma_9_v3_0_0_7_1_13_audit(const struct benchmarks_cis_Alma_9_v3_0_0_7_1_13* interface, const char* path, void* log)
{
    ...
    {
        OsConfigLogError(log, "benchmarks_cis_Alma_9_v3_0_0_7_1_13_audit: NULL argument");
        return BENCHMARK_FAILED;
    }

    if (0 != strcmp(path, "/audit"))
    {
        OsConfigLogError(log, "benchmarks_cis_Alma_9_v3_0_0_7_1_13_audit: Invalid path");
        return BENCHMARK_FAILED;
    }
...
benchmark_result_t benchmarks_cis_Alma_9_v3_0_0_7_1_13_remediate(const struct benchmarks_cis_Alma_9_v3_0_0_7_1_13* interface, const char* path, void* log)
{
    if (NULL == interface || NULL == path)
    {
        OsConfigLogError(log, "benchmarks_cis_Alma_9_v3_0_0_7_1_13_remediate: NULL argument");
        return BENCHMARK_FAILED;
    }

    if (0 != strcmp(path, "/remediate"))
    {
        OsConfigLogError(log, "benchmarks_cis_Alma_9_v3_0_0_7_1_13_remediate: Invalid path");
        return BENCHMARK_FAILED;
    }
