#include "CentOS_8_v2.0.0_3_3_3.h"
...
static benchmark_result_t audit(void* log)
{
    ...
    OsConfigLogInfo(log, "[CIS] Audit for benchmarks_cis_CentOS_8_v2_0_0_3_3_3");
...
static benchmark_result_t remediate(void *log)
{
    ...
    OsConfigLogInfo(log, "[CIS] Remediation for benchmarks_cis_CentOS_8_v2_0_0_3_3_3");
    return BENCHMARK_FAILED;
}

struct benchmarks_cis_CentOS_8_v2_0_0_3_3_3 benchmarks_cis_CentOS_8_v2_0_0_3_3_3_init()
{
    struct benchmarks_cis_CentOS_8_v2_0_0_3_3_3 interface;
...
benchmark_result_t benchmarks_cis_CentOS_8_v2_0_0_3_3_3_audit(const struct benchmarks_cis_CentOS_8_v2_0_0_3_3_3* interface, const char* path, void* log)
{
    ...
    {
        OsConfigLogError(log, "benchmarks_cis_CentOS_8_v2_0_0_3_3_3_audit: NULL argument");
        return BENCHMARK_FAILED;
    }

    if (0 != strcmp(path, "/audit"))
    {
        OsConfigLogError(log, "benchmarks_cis_CentOS_8_v2_0_0_3_3_3_audit: Invalid path");
        return BENCHMARK_FAILED;
    }
...
benchmark_result_t benchmarks_cis_CentOS_8_v2_0_0_3_3_3_remediate(const struct benchmarks_cis_CentOS_8_v2_0_0_3_3_3* interface, const char* path, void* log)
{
    if (NULL == interface || NULL == path)
    {
        OsConfigLogError(log, "benchmarks_cis_CentOS_8_v2_0_0_3_3_3_remediate: NULL argument");
        return BENCHMARK_FAILED;
    }

    if (0 != strcmp(path, "/remediate"))
    {
        OsConfigLogError(log, "benchmarks_cis_CentOS_8_v2_0_0_3_3_3_remediate: Invalid path");
        return BENCHMARK_FAILED;
    }
